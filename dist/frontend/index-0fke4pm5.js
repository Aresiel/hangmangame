...
try {
  const api = V(document.location.host);
  const ws = api.ws.index.subscribe();
  ...
  const create_session_form = assertNonNull(document.getElementById("create_session_form"), "create_session_form is null");
